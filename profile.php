...
<title>Vehicle Rental System | Profile</title>
<link rel="icon" href="assets/images/favicon-icon/favicon.png" type="image/png">
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">General Info</h5>
          <?php  
